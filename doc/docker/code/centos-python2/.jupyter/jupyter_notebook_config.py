c.NotebookApp.ip='*'
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$i200fpMdUtGn8KUDCfQ0wg$YQ9FMM0kKwNwrCTVaoD8Ig'
...
#  Choices: any of ['sha384', 'sha3_256', 'sha3_384', 'sha1', 'sha224', 'blake2b', 'sha256', 'md5', 'blake2s', 'sha3_512', 'sha512', 'sha3_224']
#  Default: 'sha256'
